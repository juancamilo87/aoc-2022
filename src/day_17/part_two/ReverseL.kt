...
data class ReverseL(val shape: IntArray, val x: Int, val y: Long, private val originalY: Long) :
  Rock {
  ...
  override fun moveAndDropNoCheck(jets: List<Char>): Rock {
    ...
    return ReverseL(newX, y - (jets.size - 1), originalY)
  }
